...
class Motores
{
  public:
    ...
    void esquerdacurva(unsigned char velocidade);
    void direitacurva(unsigned char velocidade);
    void esquerdacurvatras(unsigned char velocidade);
    void direitacurvatras(unsigned char velocidade);
    void parar();
